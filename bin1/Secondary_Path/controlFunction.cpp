...
secPath::secPath(double mu_w_param, int L_param, int M_param)
{
    mu_w = mu_w_param;
    L = L_param;
    M = M_param;
...
void secPath::setControllerInput(double residual_noise)
{
    e = residual_noise;
}
...
void *controllerInit(int argc, char *argv[])
{
    ...
    secPath *ctrl_ptr = new secPath(mu_w_param, L_param, M_param);
