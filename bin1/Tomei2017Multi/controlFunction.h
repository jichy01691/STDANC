...
*/    
    double SampleTime,g;
    Eigen::VectorXd freq,eta,eta_temp,omega,Iw;
    int N;
    // initial state
/*    Eigen::VectorXd x;
    // control gain
...
*/
    ...
    Tomei2017Multi(int N_param, std::vector<double> freq_param, double SampleTime_param, std::vector<double> Iw_param, double g_param);
    double Outputs();
    void Update();
